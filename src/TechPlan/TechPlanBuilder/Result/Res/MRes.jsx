...
class MRes extends React.Component {
    render() {
        return (
            <div style={{ height: "100%", padding: "25px", display: "flex", flexDirection: "column" }}>
                <Title style={{ paddingTop: "2px", paddingBottom: "2px", textAlign: "center" }} level={3}>产出简报</Title>
                <div style={{ overflowY: "auto", flex: 1, height: "100%" }}>
                <Title level={4} style={{ textAlign: "center" }}>平均</Title>
                <Average
                ...
                />
                <Title level={4} style={{ textAlign: "center" }}>每日</Title>
                <Daily
                ...
                />
                <Title level={4} style={{ textAlign: "center" }}>每年</Title>
                <Annual
